...
Mobile.clearText(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/txtfield_nhap_mat_khau_cu'), 
    0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/txt_vui_long_nhap_mat_khau_cu'), 
