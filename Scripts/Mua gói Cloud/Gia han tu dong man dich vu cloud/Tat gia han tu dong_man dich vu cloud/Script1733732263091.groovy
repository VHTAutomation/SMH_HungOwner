...
Mobile.verifyElementVisible(findTestObject('Settings Cam/Luu tru Cloud/Dich vu Cloud/dich_vu_cloud_popup_xac_nhan_huy_gia_han'), 0)

Mobile.tap(findTestObject('Settings Cam/Luu tru Cloud/btn_xac_nhan_gia_han'), 0)
...
Mobile.verifyElementText(findTestObject('Settings Cam/Luu tru Cloud/text_Tat_thanh_toan_tu_dong_thanh_cong'), 'Tắt thanh toán tự động thành công')
...
Mobile.verifyElementVisible(findTestObject('Settings Cam/Luu tru Cloud/Dich vu Cloud/dich_vu_cloud_btn_mua_them_goi'), 0)
