...
/*TestObject ServiceObject = new TestObject('ServiceObject')

//ServiceObject.addProperty('xpath', ConditionType.EQUALS, '//android.view.ViewGroup[.//android.widget.TextView[@text=\'Lưu trữ cloud\'] and .//android.widget.TextView[@text=\'Xem thêm\']]')

'Kiểm tra sự tồn tại của dịch vụ'
Mobile.verifyElementExist(ServiceObject, 20)
*/
...
Mobile.setText(findTestObject('ObjectTangGoiCloud/txtbox_nhap_so_dien_thoi'), '', 0)

String SerialCamera = '755464c536defb73'

Mobile.setText(findTestObject('ObjectTangGoiCloud/txt_serial_camera'), SerialCamera, 0)

Mobile.verifyElementVisible(findTestObject('ObjectTangGoiCloud/txt_vui_long_khong_de_trong_so_dien_thoai'), 0)
