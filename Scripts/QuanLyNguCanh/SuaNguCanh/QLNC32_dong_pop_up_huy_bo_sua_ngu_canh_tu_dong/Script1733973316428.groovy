...
Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_quay_lai'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_huy_bo_huy_thay_doi'), 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/txtfield_ten_ngu_canh'), 'huy bo sua ngu canh', 0)
