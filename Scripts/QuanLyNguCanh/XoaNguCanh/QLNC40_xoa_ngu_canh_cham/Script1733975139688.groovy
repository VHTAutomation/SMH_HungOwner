...
Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_xac_nhan_xoa_ngu_canh'), 0)

Mobile.tap(findTestObject('ObjectManHinhChinh/title_ca_nhan'), 0, FailureHandling.STOP_ON_FAILURE)
