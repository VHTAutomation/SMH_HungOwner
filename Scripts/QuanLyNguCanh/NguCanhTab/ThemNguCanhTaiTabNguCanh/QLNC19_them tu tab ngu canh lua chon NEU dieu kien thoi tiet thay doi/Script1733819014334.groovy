...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/txtfieldTenNguCanh'), 'Dieu kien thoi tiet thay doi tab ngu canh', 
    0)
...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectMucThongBaoDay/txtfieldNoiDungThongBao'), 
    'Dieu kien thoi tiet thay doi', 0)
