...
Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_xoa_dieu_kien_NEU'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_NEU_man_quan_ly_ngu_canh'), 0, FailureHandling.STOP_ON_FAILURE)
...
Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectDieuKienThoiTiet/txt_so_sanh'), 0)
