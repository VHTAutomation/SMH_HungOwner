...
Mobile.setText(findTestObject('ObjectSuaNha/txtbox_Nha_Giang_Xih'), '', 0)
...
/*try {
    ...
    assert toastElement.getText().equals(expectedPartialMessage): "Nội dung của toast không đúng! Nội dung thực tế là:" + toastElement.getText()
