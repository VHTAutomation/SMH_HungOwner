...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/txtfieldTenNguCanh'), 'Dieu kien thoi tiet thay doi thi thong bao', 
    0)
...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectMucThongBaoDay/txtfieldNoiDungThongBao'), 
    'Dieu kien thoi tiet thay doi 2', 0)
