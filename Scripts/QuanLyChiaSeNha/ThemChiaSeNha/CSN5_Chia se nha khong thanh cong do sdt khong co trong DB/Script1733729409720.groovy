...
Mobile.setText(findTestObject('ObjectChiaSeNha/popup_chia_se_nha_txtbox_tai_khoan_duoc_chia_se'), '0356573352', 0)
...
Mobile.verifyElementVisible(findTestObject('ObjectChiaSeNha/popup_SDT_chua_dang_image'), 0)

Mobile.verifyElementVisible(findTestObject('ObjectChiaSeNha/popup_SDT_chua_dang_ky_title'), 0)

//Mobile.verifyElementVisible(findTestObject('ObjectChiaSeNha/popup_SDT_chua_dang_ky_btn_OK'), 0)
Mobile.tap(findTestObject('ObjectChiaSeNha/popup_SDT_chua_dang_ky_btn_OK'), 0)
