...
Mobile.tap(findTestObject('ObjectThemGuongMat/banner_dung_thu_mien_phi'), 0)
...
'Set tên gương mặt là'
Mobile.setText(findTestObject('ObjectThemGuongMat/txtbox_nhap_ten_guong_mat'), 'Thu Giang3', 0)
...
face.addProperty('xpath', ConditionType.EQUALS, '//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup//android.widget.TextView[@text=\'Thu Giang3\']')
...
if (Mobile.waitForElementPresent(groupNguoiNha, 15, FailureHandling.CONTINUE_ON_FAILURE)) {
	...
	if (Mobile.waitForElementPresent(face, 10, FailureHandling.CONTINUE_ON_FAILURE)) {
		println('Gương mặt \'Thu Giang3\' tồn tại trong nhóm \'Người nhà\'.')
	} else {
		println('Gương mặt \'Thu Giang3\' không tồn tại trong nhóm \'Người nhà\'.')
	}
} else {
...
Mobile.verifyElementText(findTestObject('ObjectThemGuongMat/txtbox_ten_guong_mat_tren_man_thong_tin_GM'), 'Thu Giang3')
