...
Mobile.verifyElementText(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/txt_mat_khau_moi_khong_duoc_trung_voi_mat_khau_cu'), 
    'Mật khẩu mới không được trùng với mật khẩu cũ')

Mobile.tap(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/btn_ok_pop_up_bao_trung_mat_khau_cu'), 
    0)
