...
Mobile.setText(findTestObject('ObjectTangGoiCloud/txtbox_nhap_so_dien_thoi'), '123456789', 0)

String SerialCamera = '755464c536defb73'

Mobile.setText(findTestObject('ObjectTangGoiCloud/txt_serial_camera'), SerialCamera, 0)

Mobile.verifyElementVisible(findTestObject('ObjectTangGoiCloud/txt_So_dien_thoai_khong_hop_le'), 0)
