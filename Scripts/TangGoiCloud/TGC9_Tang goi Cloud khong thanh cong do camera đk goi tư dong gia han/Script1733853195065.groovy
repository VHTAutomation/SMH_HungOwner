...
Mobile.verifyElementVisible(findTestObject('ObjectTangGoiCloud/popup_ma_serial_dk_goi_tu_dong_gia_han_image'), 0)

Mobile.verifyElementVisible(findTestObject('ObjectTangGoiCloud/popup_ma_serial_dk_goi_tu_dong_gia_han_title'), 0)

Mobile.verifyElementVisible(findTestObject('ObjectTangGoiCloud/popup_ma_serial_dk_goi_tu_dong_gia_han_content'), 0)

Mobile.verifyElementVisible(findTestObject('ObjectTangGoiCloud/popup_ma_serial_khong dung_khong thuoc tk nhan_btn_OK'), 
    0)

Mobile.tap(findTestObject('ObjectTangGoiCloud/popup_ma_serial_dk_goi_tu_dong_gia_han_btn_OK'), 0)
