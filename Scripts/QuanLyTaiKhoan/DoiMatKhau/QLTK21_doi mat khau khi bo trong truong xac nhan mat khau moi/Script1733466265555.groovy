...
Mobile.clearText(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/txtfield_nhap_lai_mat_khau_moi'), 
    0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/txt_mat_khau_xac_nhan_khong_chinh_xac'), 
    'Mật khẩu xác nhận không chính xác.')

Mobile.verifyElementAttributeValue(findTestObject('ObjectManHinhChinh/ObjectManCaNhan/ObjectManQuanLyChung/ObjectManTaiKhoanVaBaoMat/ObjectManDoiMatKhau/btn_xac_nhan'), 
    'enabled', 'false', 0)
