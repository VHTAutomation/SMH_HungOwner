...
Mobile.setText(findTestObject('ObjectChiaSeNha/popup_chia_se_nha_txtbox_tai_khoan_duoc_chia_se'), '123456789', 0)
...
String expectedPartialMessage = 'Số điện thoại không hợp lệ'
