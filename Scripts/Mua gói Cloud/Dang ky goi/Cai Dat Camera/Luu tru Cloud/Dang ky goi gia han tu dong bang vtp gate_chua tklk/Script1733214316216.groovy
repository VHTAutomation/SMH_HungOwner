...
WebUI.callTestCase(findTestCase('Mua gói Cloud/TC Re-use/Man dang ky luu tru cloud/Gia han tu dong bang VTPay Gate- Chua co TKLK'), [:], FailureHandling.STOP_ON_FAILURE)
