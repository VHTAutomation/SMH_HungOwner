...
Mobile.tap(findTestObject('ObjectThemGuongMat/icon_qua_chuong'), 0)

Mobile.scrollToText('Ưu đãi dịch vụ', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('ObjectThemGuongMat/txt_Uu_dai_dich_vu'), 0)
...
Mobile.setText(findTestObject('ObjectThemGuongMat/txtbox_nhap_ten_guong_mat'), 'Thu Giang1', 0)
...
face.addProperty('xpath', ConditionType.EQUALS, '//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup//android.widget.TextView[@text=\'Thu Giang1\']')
...
if (Mobile.waitForElementPresent(groupNguoiNha, 15, FailureHandling.CONTINUE_ON_FAILURE)) {
    ...
    if (Mobile.waitForElementPresent(face, 10, FailureHandling.CONTINUE_ON_FAILURE)) {
        println('Gương mặt \'Thu Giang1\' tồn tại trong nhóm \'Người nhà\'.')
    } else {
        println('Gương mặt \'Thu Giang1\' không tồn tại trong nhóm \'Người nhà\'.')
    }
} else {
...
Mobile.verifyElementText(findTestObject('ObjectThemGuongMat/txtbox_ten_guong_mat_tren_man_thong_tin_GM'), 'Thu Giang1')
