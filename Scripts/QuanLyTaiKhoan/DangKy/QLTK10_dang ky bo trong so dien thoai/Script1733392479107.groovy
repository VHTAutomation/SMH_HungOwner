...
Mobile.clearText(findTestObject('ObjectDangNhap/ObjectManDangKy/txtfield_so_dien_thoai'), 0)
...
Mobile.verifyElementText(findTestObject('ObjectDangNhap/ObjectManDangKy/txt_vui_long_nhap_so_dien_thoai_cua_ban'), 'Vui lòng nhập số điện thoại của bạn')
