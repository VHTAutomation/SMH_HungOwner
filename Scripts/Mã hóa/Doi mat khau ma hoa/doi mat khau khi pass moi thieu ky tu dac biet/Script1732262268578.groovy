...
Mobile.sendKeys(findTestObject('Settings Cam/ma hoa/textbox_mat_khau_moi_ma_hoa'), 'Test1231111')
...
String error_text = Mobile.getText(findTestObject('Settings Cam/ma hoa/popup_mat_khau_moi_khong_dung_dinh_dang'), 0)
