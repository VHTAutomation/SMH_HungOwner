...
Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_xoa_ngu_canh'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/btn_huy_xoa_ngu_canh'), 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManQuanLyNguCanh/txtfield_ten_ngu_canh'), 'huy xoa ngu canh', 0)
