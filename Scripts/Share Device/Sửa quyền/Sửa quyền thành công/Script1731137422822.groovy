...
Mobile.tap(findTestObject('Share device/Thong_tin_chia_se_btn_Luu'), 0)

Mobile.verifyElementExist(findTestObject('Share device/popup_Cap nhat quyen thanh cong'), 0)
