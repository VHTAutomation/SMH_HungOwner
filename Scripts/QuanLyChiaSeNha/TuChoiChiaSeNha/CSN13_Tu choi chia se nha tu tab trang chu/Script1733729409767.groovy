...
rejectButton.addProperty('xpath', ConditionType.EQUALS, "//android.widget.TextView[@text = '$GlobalVariable.houseNameShared_Admin']/following-sibling::android.widget.TextView[@text='Từ chối']")
