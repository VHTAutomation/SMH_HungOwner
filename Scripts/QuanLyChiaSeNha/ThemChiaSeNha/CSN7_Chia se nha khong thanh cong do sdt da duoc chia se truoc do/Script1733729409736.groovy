...
Mobile.setText(findTestObject('ObjectChiaSeNha/popup_chia_se_nha_txtbox_biet_danh'), 'Phí Thị Thu Giang', 0)
...
String expectedPartialMessage = 'Số điện thoại này đang là thành viên'
