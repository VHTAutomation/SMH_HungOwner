...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/txtfieldTenNguCanh'), 'Dieu kien thoi tiet thay doi 8', 
    0)
...
Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/objCaiDatThucHienDoTre'), 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectCaiDatThucHienDoTre/txtfield_gio_thoi_gian_cho'), 
    '5', 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectCaiDatThucHienDoTre/txtfield_phut_thoi_gian_cho'), 
    '15', 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectCaiDatThucHienDoTre/txtfield_giay_thoi_gian_cho'), 
    '30', 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectCaiDatThucHienDoTre/btn_luu_thoi_gian_cho'), 
    0)
