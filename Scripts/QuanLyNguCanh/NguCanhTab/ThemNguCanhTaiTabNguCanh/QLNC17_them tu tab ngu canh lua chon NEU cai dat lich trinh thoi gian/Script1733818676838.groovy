...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/txtfieldTenNguCanh'), 'Cai dat lich trinh thoi gian tab ngu canh', 
    0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/btnNeu'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/objCaiDatLichTrinhThoiGian'), 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objGio_CaiDatLichTrinh'), 
    '18', 0)

Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objPhut_CaiDatLichTrinh'), 
    '30', 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/btnLapLai'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objThuHai'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objThuBa'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objThuTu'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objThuNam'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/objThuSau'), 0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/btnLuu_LapLai'), 
    0)

Mobile.tap(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucNeu/ObjectCaiDatLichTrinhThoiGian/btnLuu_CaiDatLichTrinh'), 
    0)
...
Mobile.setText(findTestObject('ObjectNguCanh/ObjectManThemNguCanh/ObjectMucThi/ObjectMucThongBaoDay/txtfieldNoiDungThongBao'), 
    'Cai dat lich trinh thoi gian', 0)
